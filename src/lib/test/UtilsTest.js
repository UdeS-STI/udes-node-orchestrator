...
describe('server/lib/utils', () => {
  ...
  describe('buildUrl', () => {
    it('should return an url with appended encoded query params', () => {
      ...
      const expectedUrl = 'http://exemple.com?param1=value1&param2=42&param3=email%2Cphone%2Clang%2Cname%2Csex';

      expect(buildUrl(url, params)).to.be.equal(expectedUrl);
    });
    ...
    it('should return an url with appended non-encoded query params', () => {
      ...
      const expectedUrl = 'http://exemple.com?param1=value1&param2=42&param3=[email, phone, lang, name, sex]';

      expect(buildUrl(url, params, false)).to.be.equal(expectedUrl);
    });
  });
